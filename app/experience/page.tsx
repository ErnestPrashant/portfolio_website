    ...
    <>
      <PageHeader className="mb-10">
        ...
        <PageHeaderDescription>
          ...
          of debugging. From building dynamic web applications to
      ...
      <ol className="relative mb-10 border-gray-200 border-s dark:border-gray-700">
        ...
        <li className="mb-10 ms-6">
          ...
          <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-white">
            Subject Matter Expert of Computer Science (Part-time) · Chegg
          </h3>
          <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
            Nov. 2021 - Aug. 2023
          </time>
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">
            Working as a Subject Matter Expert at Chegg, I used to solve questions
            related to Computer Science and Programming Languages. From debugging complex algorithms to 
            explaining intricate concepts, I honed my skills in problem-solving and technical communication.
          </p>
        </li>
      </ol>
